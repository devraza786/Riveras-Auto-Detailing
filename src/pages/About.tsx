      ...
      <div className="container max-w-4xl">
        ...
        <div className="space-y-4">
          {[
            ...
            "Use only the highest quality chemicals and products that guarantee satisfaction for our dealership partners.",
            "Maintain a manager on duty to inspect and approve all service quality before delivery.",
            "Ensure specialized expertise and professionalism from every detailer on your lot.",
          ].map((item, i) => (
        ...
        <div className="space-y-4">
          {[
            ...
            <AnimatedSection key={item.title} delay={i * 0.08}>
              <div className="glass-card p-4 md:p-6">
                <div className="w-10 h-[2px] bg-primary mb-2" />
                <h3 className="font-display text-lg uppercase tracking-wider mb-1">{item.title}</h3>
