...
const faqs = [
  ...
  { q: "Do you provide your own insurance and staffing?", a: "Yes. We carry comprehensive liability insurance covering all services, personnel, and vehicles on-site. We manage all staffing, training, and supervision — eliminating payroll and administrative overhead for your dealership." },
